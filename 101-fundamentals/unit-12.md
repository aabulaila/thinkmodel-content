...
>
> https://www.youtube.com/watch?v=TN4CIz7Tiys
>
> ThinkModel video — CC BY 4.0, the same licence as the text.

> **Think about this before reading on**
>
> If AI can write essays, generate art, and compose music that passes for professional work — what's left that's uniquely yours?

<details>
<summary>Hint</summary>

Think about the difference between producing something that sounds good and having something original to say in the first place.
...
> **Think about this before reading on**
>
> AI can write a poem in the style of any poet. But could it write a poem about your specific experience of watching your grandmother garden? What's the difference, and why does it matter?

<details>
<summary>Hint</summary>

Think about where the poem's content comes from. Style can be pattern-matched from training data. But whose lived experience generates the original idea?

</details>

**Knowledge check —** The Montréal creativity study found that AI beat the average human on creativity tests. What does this actually mean for human value?
...
This is the nuance that matters. AI beating the *average* human at creativity tests doesn't mean human creativity is obsolete. It means competent production — the ability to generate fluent, technically proficient output — is no longer a differentiator. What differentiates is origination: having a perspective, a voice, an insight that comes from actual experience. That's what the top 10% of humans had that AI couldn't match.
...
<details>
<summary>Deep dive: The concentration of AI power</summary>
...
Meanwhile, the question of who owns creative work is headed to the courts. Artists have sued Midjourney and Stability AI for training on their work without permission. Disney and Universal sued Midjourney for reproducing **copyright**ed characters. The US Supreme Court declined to hear a case arguing AI-generated art should be copyrightable — effectively reinforcing that copyright requires human authorship.

> **Watch out: Common misconception: AI-generated content is yours to use however you want**
>
...
> **Think about this before reading on**
>
> AI development is controlled by a handful of companies in a few countries. What questions should you be asking about who built the AI you use every day and whose values it reflects?

<details>
<summary>Hint</summary>

Think about training data decisions, content policies, and what the AI refuses to do. Who made those choices, and did they consider your perspective?

</details>

**Knowledge check —** AI development is concentrated in a few companies, countries, and cities. Why should this matter to someone who just uses AI tools?
...
Power concentration directly shapes your experience as a user. The decisions made by a small group of companies — what data to train on, what content to refuse, which languages to prioritize, what biases to address or ignore — determine the AI you interact with. When you ask "whose data is this?" (Unit 03) or notice gaps in AI knowledge, you're seeing the effects of that concentration.
...
> **AI writing alone**
>
> Fluent, well-structured, technically competent. Reads like a knowledgeable summary from someone who's read a lot but hasn't experienced anything. No personal stake. No specific perspective. Could have been written by anyone about anything. Production without origination.

> **You + AI collaborating**
>
> Your original point of view, clarified and polished by AI. The voice is yours. The perspective is specific. The insight comes from your actual experience. AI made it clearer and more polished, but the core idea — the thing that makes it worth reading — came from you. Origination amplified by production.
