...
:::embed{type="video" title="The Mirror in the Machine" src="/api/storage/public-objects/videos/3-The_Mirror_in_the_Machine.mp4" youtubeId="tROco92RGco"}
:::

:::socratic
question: AI gives great restaurant recommendations for New York but vague ones for Amman. Why do you think that happens — is the AI "smarter" about some places?
hint: Think about where the data comes from. Which cities have more reviews, articles, and online content?
concept: AI quality depends on data availability — it performs better for topics and places that are well-represented in its training data.
:::
...
The study spawned an entire subfield of AI research focused on {{term:bias|When AI output is unfairly skewed because the training data was unbalanced. The AI just reflects whatever was in the data, not on purpose.}} auditing. Cities including San Francisco, Boston, and Portland banned government use of facial recognition technology. The EU's AI Act now requires bias testing for high-risk AI systems.
...
:::analogy-target{id="p-bias-amplify"}
Here's the key insight: **AI doesn't add bias. It absorbs and amplifies whatever bias already exists in its {{term:training data|The huge collection of text, images, or other content that an AI learned from. What's in this data shapes what the AI is good at and what it gets wrong.}}.** If you train a language model on text from the internet, it will reflect the internet's preferences, blind spots, and prejudices. It will know more about topics that are well-documented online and less about topics that aren't. It will default to the perspectives of the people who wrote most of the training data.
:::

:::callout{type="warning"}
## Common misconception: More data fixes bias
...
:::quiz{id="u03-q3"}
question: An AI's safety filter can spot a request for graphic abuse and refuse it. For that filter to learn what such text looks like, people first had to:
correct: B
...
feedback_correct: Right. A filter learns its categories the way any model does — from labeled examples. TIME reported that building ChatGPT's meant workers in Nairobi reading 150 to 250 passages a shift describing abuse, torture and murder and tagging each one, for $1.32 to $2.00 an hour take-home, while OpenAI paid the vendor $12.50 per worker-hour.
feedback_incorrect: The answer is B. Safety filters aren't hand-written blocklists, you can't delete a topic from the internet, and the filter has to work before launch, not after complaints arrive. It learns from examples that people read and labeled first. TIME reported that for ChatGPT this was outsourced to workers in Nairobi labeling graphic descriptions of abuse and violence for $1.32 to $2.00 an hour take-home.
:::
:::socratic
question: Amazon built an AI hiring tool that penalized resumes containing the word "women's." Nobody programmed it to do that. So where did the bias come from?
hint: Think about what the training data looked like — 10 years of resumes in a male-dominated tech industry. What patterns would the AI find?
concept: AI absorbs patterns from its training data without judgment. If historical data reflects inequality, the AI learns to treat that inequality as the "correct" pattern.
:::

:::quiz{id="u03-q1"}
question: A facial recognition system works well on some faces and poorly on others. Based on what you know about training data, the most likely explanation is:
correct: A
...
feedback_correct: Exactly. AI systems perform best on data that's well-represented in training. Gender Shades found that commercial facial recognition datasets were 79-86% lighter-skinned faces — so the system literally had more patterns to match for those faces and fewer for everyone else.
feedback_incorrect: The answer is A. It's not about intentional design or inherent face difficulty — it's about data representation. If training data contains far more examples of some faces than others, the system has more patterns to match for overrepresented groups and fewer for underrepresented ones. This is a data problem, not a code problem.
:::
...
:::socratic
question: If you know AI performs worse for underrepresented groups, what would you do differently before relying on AI for something important — like medical advice or a job application?
hint: Think about who the AI was trained on and whether your situation is well-represented in that data.
concept: Critical AI use means assessing whether your specific context is well-represented in training data — and being more skeptical when it isn't.
:::

:::quiz{id="u03-q2"}
question: When AI gives confident, detailed answers about some topics but vague, generic answers about others, this is most likely because:
correct: D
...
feedback_correct: Right. AI doesn't have preferences or priorities — it has data density. Topics with extensive representation in training data (English-language, Western, well-documented online) produce stronger patterns and better output. Topics with thin representation produce vague, generic, or wrong answers. Same engine, different fuel.
feedback_incorrect: The answer is D. AI doesn't have interests, priorities, or deliberate limitations on topics. The difference in quality comes from data density — how much relevant content existed in the training data. The internet has far more English content than Swahili, more about New York than Nairobi. That imbalance flows directly into what the AI knows well and what it doesn't.
:::

## The Challenge

:::challenge{title="Bias Audit" time="30 minutes"}
...
:::embed{type="video" title="How I'm Fighting Bias in Algorithms — Joy Buolamwini (9 min)" id="UG_X_7g63rY" link="true"}
:::
