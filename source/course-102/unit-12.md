...
:::socratic
question: An influencer's launch-day video and your own thirty-minute benchmark run disagree about a new model. What does each source actually measure, and which is measuring your situation?
hint: One measures engagement on the average viewer's excitement; recall what the other was built from.
concept: Commentary measures attention; instruments measure your tasks. Staying current is a measurement practice, not a media diet, and the only measurements of your situation are the ones you run.
:::
...
## Common misconception: staying current means consuming more
...
:::callout{type="tip"}
## The next ladder: operating together
...
:::socratic
question: The eighteen-month graveyard buried names and spared methods. Looking at your own toolkit from this course, sort it: which parts are names, and which are methods?
hint: Ask of each artifact: does it survive every product in it being renamed?
concept: Workspaces, tiers, and tools are names: replaceable. The instruction-block pattern, the routing grid, the trio, the keys, the graph, the suite: methods, and yours. The quarterly review exists to swap the names while the methods compound.
:::

:::quiz{id="c2u12-q1" objective="U12-O1"}
question: A major lab just launched a model with a spectacular demo, and Hamza's feed says everything changed. Per this unit, his correct sequence is:
correct: C
...
feedback_correct: Instruments, not influencers, in exactly that order: the benchmark answers "better engine for my tasks?", the suite answers "does my machine survive the swap?", and the policy update makes the decision durable instead of a mood. Total time: an evening, and only if the demo earns it. Notice what C preserves that A and D destroy: his decisions remain measurements of his situation, and his attention stays his.
feedback_incorrect: The answer is C. Same-day migration (A) is vibes with confidence; permanent dismissal (B) is vibes with a frown; and outsourcing to influencer consensus (D) measures the average viewer's excitement, not his tasks. The operator's move costs thirty minutes and can't be gamed: his benchmark, his suite, his policy, his schedule.
:::
...
:::compare
before_label: The chaser
before: Reads everything, measures nothing. Stack rebuilt monthly on launch-day energy, systems untested since the day they were built, attention spent as fast as it arrives. Perpetually informed, perpetually behind, because the finish line is the feed and the feed doesn't end.
after_label: The instrument-rated operator
after: One hour, four times a year: benchmark, suite, keys, sunsets, memory, verdict, one deliberate look outward. Decisions are measurements; switches survive a thirty-minute test or don't happen; methods compound while names churn. Calm, current, and impossible to stampede.
:::
...
:::socratic
question: Four hours a year of review, powered by artifacts that took twelve units to build. What was the actual product of this course: the artifacts, or something underneath them?
hint: If every file you made were deleted tonight, what could you rebuild by next weekend, and why?
concept: The artifacts are the residue; the product is the judgment that generated them: routing, reversibility, keys, gates, measurement. That judgment rebuilds any artifact in a weekend and survives every tool the graveyard takes. It's the one thing in this field that only compounds.
:::

:::quiz{id="c2u12-q2" objective="U12-O2"}
question: At day 14 of her capstone, Noor's automation ran 10 times: 8 clean, 1 caught at the gate (a hostile comment, drafted but never sent), 1 silent skip her log surfaced and her post-mortem traced to a changed source format, now fixed and added to her suite. Her verdict should read:
correct: B
...
feedback_correct: This is what operated looks like, and the incidents are the proof, not the blemish: the hostile draft died at the gate (Units 06 and 07, working), the silent skip was caught by the log instead of by luck (Unit 08, working), and both became institutional memory (Units 06 and 11, compounding). Removing governance after a clean-ish fortnight (C) repeats the exact fallacy this course spent five units burying: success is when the guardrails earned their keep, never evidence they're no longer needed.
feedback_incorrect: The answer is B. Zero incidents (A) isn't the standard; caught incidents are: systems meet the real world, and governance exists for exactly these ten runs. Removing the gate and log (C) confuses "protected" with "safe unprotected," and gating every node (D) rebuilds the approval-fatigue machine Unit 06 dismantled. Operated means: it ran, it was watched, it was caught when it strayed, it got smarter on record, and it keeps its governance.
:::

## The Challenge

:::challenge{title="The Capstone: Two Weeks in the Chair" time="2 weeks, about 20 minutes per day"}
