...
>
> An influencer's launch-day video and your own thirty-minute benchmark run disagree about a new model. What does each source actually measure, and which is measuring your situation?

<details>
<summary>Hint</summary>

One measures engagement on the average viewer's excitement; recall what the other was built from.
...
> **Watch out: Common misconception: staying current means consuming more**
>
...
<details>
<summary>Tip: The next ladder: operating together</summary>
...
> **Think about this before reading on**
>
> The eighteen-month graveyard buried names and spared methods. Looking at your own toolkit from this course, sort it: which parts are names, and which are methods?

<details>
<summary>Hint</summary>

Ask of each artifact: does it survive every product in it being renamed?

</details>

**Knowledge check —** A major lab just launched a model with a spectacular demo, and Hamza's feed says everything changed. Per this unit, his correct sequence is:
...
> **The chaser**
>
> Reads everything, measures nothing. Stack rebuilt monthly on launch-day energy, systems untested since the day they were built, attention spent as fast as it arrives. Perpetually informed, perpetually behind, because the finish line is the feed and the feed doesn't end.

> **The instrument-rated operator**
>
> One hour, four times a year: benchmark, suite, keys, sunsets, memory, verdict, one deliberate look outward. Decisions are measurements; switches survive a thirty-minute test or don't happen; methods compound while names churn. Calm, current, and impossible to stampede.
...
> **Think about this before reading on**
>
> Four hours a year of review, powered by artifacts that took twelve units to build. What was the actual product of this course: the artifacts, or something underneath them?

<details>
<summary>Hint</summary>

If every file you made were deleted tonight, what could you rebuild by next weekend, and why?

</details>

**Knowledge check —** At day 14 of her capstone, Noor's automation ran 10 times: 8 clean, 1 caught at the gate (a hostile comment, drafted but never sent), 1 silent skip her log surfaced and her post-mortem traced to a changed source format, now fixed and added to her suite. Her verdict should read:
...
### Challenge: The Capstone: Two Weeks in the Chair

*Time: 2 weeks, about 20 minutes per day*
